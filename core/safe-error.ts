...
function genericReasonMessage(record: SafeErrorRecord): string | undefined {
  ...
  return {
    ...
    VAULT_PULL_DOWNLOAD_FAILED: "远端文件未能完成下载和完整性校验；本地文件未被覆盖，请检查连接后重试。",
    VAULT_PULL_STAGING_FAILED: "远端文件已下载，但无法安全写入本地暂存区；正式文件未被覆盖，请检查磁盘空间和目录权限。",
    VAULT_PULL_WRITE_FAILED: "远端文件已验证，但无法安全应用到 Vault；原文件和恢复记录均已保留。",
    VAULT_PULL_DELETE_FAILED: "远端删除已验证，但本地文件无法安全移入恢复区；原文件仍保留。",
    VAULT_PULL_LOCAL_APPLY_FAILED: "本地应用遇到未识别异常；插件没有选择任一版本，也没有覆盖活动文件。请复制脱敏诊断包。",
