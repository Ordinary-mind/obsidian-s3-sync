...
export function configRegisterVersion(repositoryId: string, versionId: string, mutation: ConfigSnapshotMutation): RegisterVersion {
  return registerVersion(repositoryId, "config", mutation.key, versionId, mutation.parents);
}
